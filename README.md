...
This app works alongside the Top One Admin App. The admin app manages salon content and operational data, while this guest app reads that shared data from Supabase and presents it to customers in a read-focused experience.
...
- booking requests create message conversations that admins can continue manually
